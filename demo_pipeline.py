...
def model_analysis_pipeline(current_path, filename):
    ...
    # step 3
    cross_section_scan = "python3 crossection_scan_ptvpy.py -p " + current_path + "cross_section_scan/" 
    
    #cross_section_scan = "python3 /opt/code/crossection_scan_ptvpy.py -p " + current_path + "cross_section_scan/" 
    
    print("Tracking level set cross-section image sequence to generate labeled segmentation results...\n")
    ...
    # step 5
    trace_analysis = "python3 track_load_ori.py -p " + current_path + "cross_section_scan/" + " -f " + " trace_result.csv " + " -v True " 
    #trace_analysis = "python3 /opt/code/track_load_ori.py -p " + current_path + "cross_section_scan/" + " -f " + " trace_result.csv " + " -v True " 
